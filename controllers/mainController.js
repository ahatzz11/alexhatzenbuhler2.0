    ...
    */
    ...
    function problem2() {
        ...
        for(var i = 0; i < packages.length; i++) {
            ...
            var dimensions = packages[i].split('x');

            var side1 = dimensions[0] * dimensions[1];
            var side2 = dimensions[0] * dimensions[2];
            var side3 = dimensions[1] * dimensions[2];

            var smallest = Math.min(side1, side2, side3);

            currentArea = (2*side1) + (2*side2) + (2*side3) + smallest;
            ...
            var cubicfeet =  dimensions[0] * dimensions[1] * dimensions[2];

            currentFeet = perimeter + cubicfeet;
    ...
    function getMyInformation() {
        ...
        var json = '{' +
          '"About Me": {' +
            '"descriptions": [' +
              '"Hi! My name is Alex Hatzenbuhler. I grew up in Apple Valley MN and am currently a Senior at North Dakota State University. I will be graduating in May 2015 with a Bachelors of Science degree in Computer Science. I have been interested in anything related to technology since I was tall enough to reach the VCR machine. I started coding and developing my freshman year of college and I soon became passionate about computer science. Since then I have developed a strong interest in android and web development.",' +
              '"Outside of my professional interests I listen to a lot of music, discover many unique craft beers, and enjoy staying up to date on all things related to technology. I have developed an interest in some computer hardware as well. I built my own desktop computer a couple years ago, and have helped a few friends with their own. I also enjoy biking, snowboarding, and playing ultimate frisbee in my free time."' +
            ']' +
          '},' +
          '"projects": [' +
            '{' +
              '"name": "Counter for Wear",' +
              '"link": "https://github.com/ahatzz11/Counter-for-Wear",' +
              '"descriptions": [' +
            ...
            '{' +
              '"name": "Hotel System",' +
              '"link": "https://github.com/ahatzz11/Hotel-System",' +
              '"descriptions": [' +
                '"A parallelized hotel reservation system",' +
                '"Parallelization is achieved by the use semaphores",' +
                '"Language: C++"' +
              ']' +
            '},' +
            '{' +
              '"name": "k-Means",' +
              '"link": "https://github.com/ahatzz11/k-Means",' +
              '"descriptions": [' +
                '"Implementation of the k-Means algorithm both in serial, and parallel",' +
                '"Language: Python"' +
              ']' +
            '},' +
            '{' +
